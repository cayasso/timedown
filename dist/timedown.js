...
var Counter = function (_Emitter) {
  ...
  function Counter(timer, name, time) {
    ...
    _this.timer = timer;
    _this._duration = 0;
    _this.ns = String(name);
    _this.options = options;
    _this.init(time, options);
    return _this;
  }
...
},{"eventemitter3":192,"ms":194}],2:[function(require,module,exports){
'use strict';
...
var Timer = function (_Emitter) {
  ...
  function Timer() {
    ...
    _this.tock = new _tickTock2.default(_this);
...
},{"./counter":1,"babel-polyfill":3,"eventemitter3":192,"tick-tock":196}],3:[function(require,module,exports){
(function (global){
"use strict";
...
},{"_process":195}],5:[function(require,module,exports){
